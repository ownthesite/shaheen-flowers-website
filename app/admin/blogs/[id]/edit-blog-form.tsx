      ...
      <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-stone-200 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-3xl md:text-4xl font-light tracking-tight text-stone-900">
            Edit <span className="font-serif italic text-stone-500">Entry</span>
          </h1>
        </div>
              ...
              <div className="p-10 flex flex-col items-center justify-center text-center">
                {form.featured_image ? (
                  <div className="space-y-4">
                    ...
                    />
                    <p className="text-sm font-medium text-stone-900 uppercase tracking-widest underline underline-offset-4 decoration-stone-300">
